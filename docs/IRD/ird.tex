...
Assim, podemos obter o quão próximo está a amostra desse máximo teórico realizando $I/I_{\max}$, o que fornece o fator de normalização.}, sendo que o limite superior é determinado pelo grau de desequilíbrio inicial entre as distribuições amostral e populacional. A interpretação é direta:
\begin{itemize}

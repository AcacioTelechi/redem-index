\section{Índice de Representação Descritiva (IRD)}
...
\begin{equation}
I = 1 - \frac{1}{2(N-1)} \sum_{i=1}^{N} |w_i - 1|, \quad \sum_i w_i = N
\end{equation}
...
\begin{itemize}
    \item Se $I = 1$, a amostra já reproduz exatamente as proporções populacionais, de modo que não há necessidade de ajuste;
    \item Quanto menor o valor de $I$, maior é o desvio médio dos pesos em relação a 1, refletindo ajustes mais intensos para compensar discrepâncias entre amostra e população.
\end{itemize}
...
\input{IRD/validacao_e_aplicacao.tex}